    ...
    <section class='detail-container'>
      {page.includes('typro')
        ? [
          ...
          <p class='new-detail-text'>„typro“ ist eine Progressive Web App, die es Nutzern erlaubt, mit Hilfe ihrer Smartphone-Kamera Schriftarten zu identifizieren, die gescannten Schriftarten samt Foto zu speichern und einen Katalog populärer Schriften zu durchsuchen. typro ist eines meiner ersten umfangreicheren Projekte und lässt sich <a href="https://typro.jonaskuske.com">hier</a> live ausprobieren.</p>,
          <ImageText src={img1} mode='left'>Die Idee, verschiedene Marketingkonzepte sowie das Design entstanden im Modul „Marketing“. Gemeinsam mit meinen Kommilitonen <a href="http://riekehelmers.com">Rieke Helmers</a> und <a href="https://maxmschneider.com">Max M. Schneider</a> habe ich das Projekt anschließend als Abschlussarbeit im Modul „Programmieren“ prototypisch umgesetzt; das Projekt erhielt 99,5 von 100 möglichen Punkten. <br />
