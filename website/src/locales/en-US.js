export default {
  ...
  About: {
    ...
    skills: [
      ...
      },
      {
        type: 'Design',
        text:
          "At the same time I'm into modern and sleek design. Clear, geometric elements and a minimalistic look are my golden rules - only to break them when neccessary. Good design is predictably unpredictable.",
        skills: [
          {
            name: 'Illustrator',
  ...
  Legal: {
    ...
    Privacy: {
      ...
      colorSync:
        ...
        'With exception of the cases described above, this site does not collect or use any personal information.',
    },
  },
  Error: {
  ...
  PairYourPhone: {
    ...
    description:
      'Visit <a href="https://jonaskuske.com/colorpicker" rel="noopener">jonaskuske.com/colorpicker</a> on your phone and scan the QR Code or enter your ID.',
