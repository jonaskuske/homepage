...
export default {
  ...
  blocks: [
    ...
    {
      image: dmpTwo,
      text: 'Für die Realisierung als SPA entschied sich unser Team für das JavaScript Framework Vue.js und einen modernen Build-Workflow basierend auf Webpack 3. Das Frontend ist bereits weit fortgeschritten, eine nonfinale Testversion lässt sich <a href="http://dmp-portfolio.jonaskuske.com" rel="noopener" target="_blank">hier</a> begutachten. <br/> Was das Backend betrifft, evaluieren Team & Management aktuell noch die Vor- und Nachteile von selbstgeschriebenem Backend (Node oder PHP) und der Verwendung eines Headless CMS.'
    }
  ],
