...
export default {
  ...
  footer:
    'Apart from typical communication equipment like business cards or letterheads the design manual also includes a possible redesign of the sport association’s homepage. For demonstration purposes and to let the client directly compare the old and the new website design, I built the redesigned site prototypically as a Vue.js-driven webapp - you can find more about it <a href="/detail?project=lsb-homepage">here</a>.',
}
