...
export default {
  ...
  showcase: {
    ...
    text:
      'A geometric typeface, based on elementary forms and bound by strict rules. Readibility was not the main focus of this project, the goal was to define strict principles and not depart from them even if it makes the font less readable. The circle elements give the font its name: »Serpens Pro«.',
  },
  blocks: [
    {
      image: serpens1,
      text:
        'The elements used to form the letters of »Serpens Pro« - divided circles and lines in corresponding lengths. For capital letters, individual parts must not overlap, instead gaps are used to achieve appropriate dimensions. For minuscules overlapping is permitted to ensure more compact visuals.',
    },
    {
      image: serpens2,
      text:
